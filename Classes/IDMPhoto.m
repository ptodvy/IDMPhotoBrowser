...
- (void)loadUnderlyingImageAndNotify {
    ...
    if (self.underlyingImage) {
        ...
        if (_photoPath) {
            ...
            [[SDWebImageManager sharedManager] loadImageWithURL:_photoURL options:SDWebImageRetryFailed|SDWebImageQueryMemoryData|SDWebImageQueryMemoryDataSync|SDWebImageQueryDiskDataSync progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
